...
/**
 * Base class that represents a row from the 'typeAssurance' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Typeassurance implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\App\\Http\\Model\\Map\\TypeassuranceTableMap';
    ...
    /**
     * Initializes internal state of App\Http\Model\Base\Typeassurance object.
     */
    ...
    /**
     * Compares this with another <code>Typeassurance</code> instance.  If
     * <code>obj</code> is an instance of <code>Typeassurance</code>, delegates to
     * <code>equals(Typeassurance)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TypeassuranceTableMap::COL_ID] = true;
        }
    ...
    public function setNom($v)
    {
        ...
        if ($this->nom !== $v) {
            $this->nom = $v;
            $this->modifiedColumns[TypeassuranceTableMap::COL_NOM] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[TypeassuranceTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setDatecreation($v)
    {
        ...
        if ($this->datecreation !== null || $dt !== null) {
            if ($this->datecreation === null || $dt === null || $dt->format("Y-m-d") !== $this->datecreation->format("Y-m-d")) {
                $this->datecreation = $dt === null ? null : clone $dt;
                $this->modifiedColumns[TypeassuranceTableMap::COL_DATECREATION] = true;
            }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TypeassuranceTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TypeassuranceTableMap::translateFieldName('Nom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TypeassuranceTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TypeassuranceTableMap::translateFieldName('Datecreation', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            ...
            return $startcol + 4; // 4 = TypeassuranceTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Http\\Model\\Typeassurance'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildTypeassuranceQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see Typeassurance::setDeleted()
     * @see Typeassurance::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTypeassuranceQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TypeassuranceTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(TypeassuranceTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TypeassuranceTableMap::COL_NOM)) {
            $modifiedColumns[':p' . $index++]  = 'nom';
        }
        if ($this->isColumnModified(TypeassuranceTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(TypeassuranceTableMap::COL_DATECREATION)) {
            $modifiedColumns[':p' . $index++]  = 'dateCreation';
        }

        $sql = sprintf(
            'INSERT INTO typeAssurance (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'description':
                        ...
                        break;
                    case 'dateCreation':
                        $stmt->bindValue($identifier, $this->datecreation ? $this->datecreation->format("Y-m-d") : null, PDO::PARAM_STR);
    ...
    {
        $pos = TypeassuranceTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Typeassurance'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['Typeassurance'][$this->hashCode()] = true;
        $keys = TypeassuranceTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNom(),
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(TypeassuranceTableMap::COL_ID)) {
            $criteria->add(TypeassuranceTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TypeassuranceTableMap::COL_NOM)) {
            $criteria->add(TypeassuranceTableMap::COL_NOM, $this->nom);
        }
        if ($this->isColumnModified(TypeassuranceTableMap::COL_DESCRIPTION)) {
            $criteria->add(TypeassuranceTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(TypeassuranceTableMap::COL_DATECREATION)) {
            $criteria->add(TypeassuranceTableMap::COL_DATECREATION, $this->datecreation);
        }
    ...
    {
        $criteria = ChildTypeassuranceQuery::create();
        $criteria->add(TypeassuranceTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \App\Http\Model\Typeassurance (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Http\Model\Typeassurance Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * If this ChildTypeassurance is new, it will return
    ...
    public function setSouscriptionassurances(Collection $souscriptionassurances, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($souscriptionassurancesToDelete as $souscriptionassuranceRemoved) {
            $souscriptionassuranceRemoved->setTypeassurance(null);
        }
    ...
    protected function doAddSouscriptionassurance(ChildSouscriptionassurance $souscriptionassurance): void
    {
        ...
        $souscriptionassurance->setTypeassurance($this);
    }
    ...
    public function removeSouscriptionassurance(ChildSouscriptionassurance $souscriptionassurance)
    {
        if ($this->getSouscriptionassurances()->contains($souscriptionassurance)) {
            ...
            $souscriptionassurance->setTypeassurance(null);
        }
     ...
     * Otherwise if this Typeassurance is new, it will return
     * an empty collection; or if this Typeassurance has previously
     * been saved, it will retrieve related Souscriptionassurances from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Typeassurance.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildSouscriptionassurance}> List of ChildSouscriptionassurance objects
     */
    public function getSouscriptionassurancesJoinReservation(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSouscriptionassuranceQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(TypeassuranceTableMap::DEFAULT_STRING_FORMAT);
    }
