...
abstract class Reserver implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\App\\Http\\Model\\Map\\ReserverTableMap';
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $this->qtereserver = (null !== $col) ? (int) $col : null;
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'numTypeContainer':
                        ...
                        break;
                    case 'qteReserver':
                        $stmt->bindValue($identifier, $this->qtereserver, PDO::PARAM_INT);
    ...
    public function hashCode()
    {
        ...
        //relation fk_codres to table reservation
        ...
        //relation fk_codtyp to table typeContainer
