...
abstract class Devis implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\App\\Http\\Model\\Map\\DevisTableMap';
    ...
    /**
     * Get the [optionally formatted] temporal [datedevis] column value.
     *
     *
     ...
     */
    public function getDatedevis($format = null)
    {
        if ($format === null) {
            return $this->datedevis;
        } else {
            return $this->datedevis instanceof \DateTimeInterface ? $this->datedevis->format($format) : null;
        }
    }
    ...
    /**
     * Sets the value of [datedevis] column to a normalized version of the date/time value specified.
     *
    ...
    public function setDatedevis($v)
    {
        ...
        if ($this->datedevis !== null || $dt !== null) {
            if ($this->datedevis === null || $dt === null || $dt->format("Y-m-d") !== $this->datedevis->format("Y-m-d")) {
                $this->datedevis = $dt === null ? null : clone $dt;
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $this->datedevis = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'codeDevis':
                        ...
                        break;
                    case 'dateDevis':
                        $stmt->bindValue($identifier, $this->datedevis ? $this->datedevis->format("Y-m-d") : null, PDO::PARAM_STR);
